...
public class Main {
    public static void main(String[] args) {
        ...
        Alien a5 = session1.get(Alien.class, 101); // this is not firing a select query because of default l1 cache provided by hibernate, we can do sharing of data between multiple sessions using some libraries - l2 caching(Jcache(chcache, cafffine))
